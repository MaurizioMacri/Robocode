...
public class Damala extends AdvancedRobot {
	...
	private Priorknowledge prior = new Priorknowledge();
	...
	private void initializeStuff() {
		...
		prior.setPath_file(getDataDirectory().getPath());
		System.out.println("F "+situationsKDTree.size());
		if(first){
		prior.loadPriorKnowledge(situationsKDTree);
		first=false;
		}
		System.out.println(situationsKDTree.size());
	}
